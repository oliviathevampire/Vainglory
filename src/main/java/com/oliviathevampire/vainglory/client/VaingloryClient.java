...
public class VaingloryClient implements ClientModInitializer {
	...
	public static final Map<Item, ModelResourceLocation> BIG_MODELS = Map.of(
			...
			VGItems.AXE_OF_CLEAVING, ModelResourceLocation.inventory(Vainglory.id("axe_of_cleaving_big")),
			VGItems.STAFF, ModelResourceLocation.inventory(Vainglory.id("staff_big"))
	);
